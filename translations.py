...
TRANSLATIONS = {
    "en": {
        ...
        "Generic Greeting Placeholder (e.g., 'Dear Friends')": "Designation for {{Name}} (e.g., 'Team', 'Friends')",
        "Enter your instruction for the AI agent:": "Enter your instruction for the AI agent:",
        "Please upload an Excel file with contacts first.": "Please upload an Excel file with contacts first.",
        "Please enter an instruction for the AI agent.": "Please enter an instruction for the AI agent.",
    ...
    "fr": {
        ...
        "Generic Greeting Placeholder (e.g., 'Dear Friends')": "Appellation pour {{Name}} (ex: 'Migdaliens', 'Amis')",
        "Enter your instruction for the AI agent:": "Saisissez votre instruction pour l'agent IA :",
        "Please upload an Excel file with contacts first.": "Veuillez d'abord télécharger un fichier Excel avec des contacts.",
        "Please enter an instruction for the AI agent.": "Veuillez saisir une instruction pour l'agent IA.",
